 ...
 * @author			Raymond Benc
 * @package 		Phpfox
 * @version 		$Id: image.php 7303 2014-05-07 17:43:19Z Fern $
 */
...
if (isset($_GET['pq']))
{
	...
	{
		$sFile = Phpfox::getParam('user.url_user_spam') . $sPath;
		$sFile = Phpfox::getLib('cdn')->getUrl($sFile, Phpfox::getLib('cdn')->getServerId());
	}
