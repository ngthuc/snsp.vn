...
$Behavior.bookbulktemplate = function(){
	/*Aside*/
	$('.bookbulk_aside').find('.open_aside').live('click',function() {
		$('.bookbulk_aside').addClass('bookbulk_aside_full');
		$('.bookbulk_core_body').addClass('bookbulk_core_body_aside');
		$('.bookbulk_header').addClass('bookbulk_header_aside');
		$('.open_aside').addClass('close_aside').removeClass('open_aside');
		$('.sub_active').next('.bookbulk_main_extra').css('display','block');
		$.ajaxCall('bookbulktemplate.updateSetting','asideStatus=1');
	});
	$('.bookbulk_aside_full').find('.close_aside').live('click',function() {
		$('.bookbulk_aside').removeClass('bookbulk_aside_full');
		$('.bookbulk_core_body').removeClass('bookbulk_core_body_aside');
		$('.bookbulk_header').removeClass('bookbulk_header_aside');
		$('.close_aside').addClass('open_aside').removeClass('close_aside');
		$('.sub_active').next('.bookbulk_main_extra').css('display','none');
		$.ajaxCall('bookbulktemplate.updateSetting','asideStatus=0');
	});
	$('.bookbulk_search_img').click(function() {
		$('.bookbulk_aside').addClass('bookbulk_aside_full');
		$('.bookbulk_core_body').addClass('bookbulk_core_body_aside');
		$('.bookbulk_header').addClass('bookbulk_header_aside');
		$('.open_aside').addClass('close_aside').removeClass('open_aside');
	...
	$('.bookbulk_menu_img').click(function() {
		$('.bookbulk_aside').addClass('bookbulk_aside_full');
		$('.bookbulk_core_body').addClass('bookbulk_core_body_aside');
		$('.bookbulk_header').addClass('bookbulk_header_aside');
		$('.open_aside').addClass('close_aside').removeClass('open_aside');
