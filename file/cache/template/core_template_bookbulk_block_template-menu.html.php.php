...
<?php if ($this->_aVars['aMainMenu']['url'] == ''): ?>
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('theme' => 'favorites/menu/home.png','class' => 'v_middle')); ?>
<?php elseif ($this->_aVars['aMainMenu']['url'] == 'user.browse'): ?>
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('theme' => 'favorites/menu/members.png','class' => 'v_middle')); ?>
<?php elseif ($this->_aVars['aMainMenu']['url'] == 'friend'): ?>
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('theme' => 'favorites/menu/friends.png','class' => 'v_middle')); ?>
<?php elseif ($this->_aVars['aMainMenu']['url'] == 'pages'): ?>
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('theme' => 'favorites/menu/pages.png','class' => 'v_middle')); ?>
<?php elseif ($this->_aVars['aMainMenu']['url'] == 'blog'): ?>
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('theme' => 'favorites/menu/blogs.png','class' => 'v_middle')); ?>
<?php elseif ($this->_aVars['aMainMenu']['url'] == 'photo'): ?>
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('theme' => 'favorites/menu/photos.png','class' => 'v_middle')); ?>
<?php elseif ($this->_aVars['aMainMenu']['url'] == 'forum'): ?>
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('theme' => 'favorites/menu/forum.png','class' => 'v_middle')); ?>
<?php elseif ($this->_aVars['aMainMenu']['url'] == 'poll'): ?>
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('theme' => 'favorites/menu/polls.png','class' => 'v_middle')); ?>
<?php elseif ($this->_aVars['aMainMenu']['url'] == 'video'): ?>
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('theme' => 'favorites/menu/videos.png','class' => 'v_middle')); ?>
<?php elseif ($this->_aVars['aMainMenu']['url'] == 'quiz'): ?>
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('theme' => 'favorites/menu/quizzes.png','class' => 'v_middle')); ?>
<?php elseif ($this->_aVars['aMainMenu']['url'] == 'event'): ?>
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('theme' => 'favorites/menu/events.png','class' => 'v_middle')); ?>
<?php elseif ($this->_aVars['aMainMenu']['url'] == 'music'): ?>
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('theme' => 'favorites/menu/music.png','class' => 'v_middle')); ?>
<?php elseif ($this->_aVars['aMainMenu']['url'] == 'marketplace'): ?>
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('theme' => 'favorites/menu/marketplace.png','class' => 'v_middle')); ?>
<?php elseif ($this->_aVars['aMainMenu']['url'] == 'apps'): ?>
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('theme' => 'favorites/menu/apps.png','class' => 'v_middle')); ?>
<?php else: ?>
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('theme' => 'favorites/menu/default.png','class' => 'v_middle')); ?>
<?php endif; ?>
