...
<?php if (PHPFOX ::isUser()): ?>
                        <aside class="bookbulk_aside <?php if ($this->_aVars['asideStatus']): ?> bookbulk_aside_full<?php endif; ?>">
                        <div class="bookbulk_navigation_sidebar">
                        <i class="icon-align-justify <?php if (! $this->_aVars['asideStatus']): ?> open_aside<?php else: ?> close_aside<?php endif; ?>">SCROLLERBARBOOKBULKTHEMPLATESSIDE</i>
                        </div>
                        </aside>
<?php endif; ?>
