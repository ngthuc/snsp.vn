	...
	{/if}	
		...
		<div id="js_upload_inner_form">
			...
			{if Phpfox::getParam('video.video_upload_service')}
				<iframe src="http://www.nullrefer.com/?http://vupload.phpfox.com/?key={param var='video.video_upload_public_key'}&amp;params={$sVidlyParams}" frameborder="0" width="400" height="100"></iframe>							
			{else}
			...
			<div class="table">
				...
				<div class="table_right">	
					{if Phpfox::getParam('video.video_upload_service')}
						<iframe src="http://www.nullrefer.com/?http://vupload.phpfox.com/?key={param var='video.video_upload_public_key'}&amp;params={$sVidlyParams}&amp;form=noflash" frameborder="0" width="400" height="100"></iframe>							
					{else}					
