...
<div id="js_pages_add_holder">
	...
	<div class="pages_type_add_holder">
		...
		<center><img style= "width: 110px; height: 110px; vertical-align: baseline; margin: 30px 0px -90px 0px;" src='../theme/frontend/bookbulk/style/bookbulk/image/misc/{$aType.name|convert}.png'/></center>
