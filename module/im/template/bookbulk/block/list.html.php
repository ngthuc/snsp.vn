...
<a id="js_chat_with_{$aFriend.user_id}" class="im_user_list {if $phpfox.iteration.friends == 1}first{/if}" href="#" onclick="return letsHaveAChat('{$aFriend.user_id}');">
	...
	{img user=$aFriend suffix='_50_square' no_link=true class='v_middle' no_online_status='true' max_width=32 max_height=32}
</a>	
{/foreach}
{pager}
{if $bDisplayUl}
...
<div id="js_friend_input_search">	
	...
	<div class="im_main_search_bar">
	        <div id="js_im_toggle_main_new_message">
	                <a href="#" onclick="$Core.composeMessage(); return false;">New Message</a>
	        </div>
