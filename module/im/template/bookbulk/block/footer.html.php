	...
	<div id="im_footer_wrapper">
		<ul id="im_footer_bar">
			...
			<li id="js_im_holder">
				...
				{if PHPFOX::isUser()}
                        <aside class="bookbulk_aside {if $asideStatus} bookbulk_aside_full{/if}">
                        <div class="bookbulk_navigation_sidebar">
                        <i class="icon-align-justify {if !$asideStatus} open_aside{else} close_aside{/if}">SCROLLERBARBOOKBULKTHEMPLATESSIDE</i>
                        </div>
                        </aside>
                                {/if}
