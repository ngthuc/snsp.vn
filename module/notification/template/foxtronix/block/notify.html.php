<li>
	...
	<a href="#" title="{phrase var='notification.notifications'}" class="notification notify_drop_link" rel="notification.getAll">
	<i class="icon-globe"></i>
	</a>
	<div class="holder_notify_drop mac_holder_notify_drop_notification">
		<div class="mac_notify_drop_up_arrow mac_notify_drop_up_arrow_notification"></div>
