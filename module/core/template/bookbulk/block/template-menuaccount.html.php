{if Phpfox::getUserBy('profile_page_id') > 0}								
									...
									{else}
									<ul>
									<li class="image_user" style="height: 32px;">{img user=$aGlobalUser suffix='_50_square' max_width=30 max_height=30}
                                                                        <div id="bammer">{$aGlobalUser|user|shorten:16:''}</div>
                                                                        </li>
                                                                        <li class="head_divider"></li>
                                                                        <li><a href="{url link=''}">{phrase var='core.menu_home'}</a>
