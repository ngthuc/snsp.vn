						...
						<ul>	
							...
							{/if}
								<li rel="menu{$aMainMenu.menu_id}" {if (isset($iTotalHide) && isset($iMenuCnt) && $iMenuCnt > $iTotalHide)} style="display:none;" {/if} {if (($aMainMenu.url == 'apps' && count($aInstalledApps)) || (isset($aMainMenu.children) && count($aMainMenu.children))) || (isset($aMainMenu.is_force_hidden))}class="{if isset($aMainMenu.is_force_hidden) && isset($iTotalHide)}is_force_hidden{else}explore{/if}{if ($aMainMenu.url == 'apps' && count($aInstalledApps))} explore_apps{/if}"{/if}><a {if !isset($aMainMenu.no_link) || $aMainMenu.no_link != true}href="{url link=$aMainMenu.url}" {else} href="#" onclick="return false;" {/if} class="{if isset($aMainMenu.is_selected) && $aMainMenu.is_selected} menu_is_selected {/if}{if isset($aMainMenu.external) && $aMainMenu.external == true}no_ajax_link {/if}ajax_link">
								        {if $aMainMenu.url == ''}
									{img theme='favorites/menu/home.png' class='v_middle'}
									{elseif $aMainMenu.url == 'user.browse'}
									{img theme='favorites/menu/members.png' class='v_middle'}
								        {elseif $aMainMenu.url == 'friend'}
									{img theme='favorites/menu/friends.png' class='v_middle'}
									{elseif $aMainMenu.url == 'pages'}
									{img theme='favorites/menu/pages.png' class='v_middle'}
									{elseif $aMainMenu.url == 'blog'}
									{img theme='favorites/menu/blogs.png' class='v_middle'}
									{elseif $aMainMenu.url == 'photo'}
									{img theme='favorites/menu/photos.png' class='v_middle'}
									{elseif $aMainMenu.url == 'forum'}
									{img theme='favorites/menu/forum.png' class='v_middle'}
									{elseif $aMainMenu.url == 'poll'}
									{img theme='favorites/menu/polls.png' class='v_middle'}
									{elseif $aMainMenu.url == 'video'}
									{img theme='favorites/menu/videos.png' class='v_middle'}
									{elseif $aMainMenu.url == 'quiz'}
									{img theme='favorites/menu/quizzes.png' class='v_middle'}
									{elseif $aMainMenu.url == 'event'}
									{img theme='favorites/menu/events.png' class='v_middle'}
									{elseif $aMainMenu.url == 'music'}
									{img theme='favorites/menu/music.png' class='v_middle'}
									{elseif $aMainMenu.url == 'marketplace'}
									{img theme='favorites/menu/marketplace.png' class='v_middle'}
									{elseif $aMainMenu.url == 'apps'}
					                                {img theme='favorites/menu/apps.png' class='v_middle'}							
									{else}
									{img theme='favorites/menu/default.png' class='v_middle'}
									{/if}
