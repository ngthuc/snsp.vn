 ...
 * @version 		$Id: index.html.php 2009-10-12 Nicolas $
 */
 
defined('PHPFOX') or exit('NO DICE!'); 
?>
{if !count($aVideos)}
<div class="extra_info">{phrase var='youtube.no_videos'}</div>
{else}
<div id="js_video_outer_body">
	{foreach from=$aVideos name=videos item=aVideo}
			<div class="t_center js_video_parent" style="height:170px; width:31%; margin-bottom:10px; float:left; padding-top:5px; z-index:1; margin-right:2px; position:relative;" id="js_video_id_{$aVideo.vid}">		
