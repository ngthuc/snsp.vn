...
{if Phpfox::getParam('user.user_browse_display_results_default') == 'name_photo_detail'}
	...
	<div class="{if is_int($phpfox.iteration.users/2)}row1{else}row2{/if}{if $phpfox.iteration.users == 1} row_first{/if}" style="border-bottom:0 none; position: relative; width: 260px; float: right; margin: 5px; padding-top: 10px; height: 100px; background:linear-gradient(to top, #FFFFFF, #EEEEEE) repeat scroll 0 0 transparent; border-radius: 2px;" id="js_parent_user_{$aUser.user_id}">
