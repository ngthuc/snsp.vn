...
<div class="user_register_holder">
	<div class="holder">
		<div class="user_register_intro">	
			<div class="extra_infoo"> ورود </div>
...
{/if}
		...
		{$sCreateJs}
		{/if}
		<div id="js_registration_process" class="t_center" style="display:none; height:30px;">
			<div class="p_top_8">				
		...
		{if Phpfox::getParam('user.allow_user_registration')}
			<div class="main_breakpro" id="js_registration_holder">	
