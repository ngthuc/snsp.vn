 ...
 */
class Newsletter_Service_Callback extends Phpfox_Service
{
	/**
	 * Class constructor
	 */	
	...
	public function getNotificationSettings()
	{
		...
		{
			return array('newsletter.can_receive_notification' => array(
				'phrase' => Phpfox::getPhrase('newsletter.receive_newsletter'),
				'default' => 1
				)
			);
		}
